  ...
  return (
    <div className="relative">
      <div className="bg-white/80 rounded-xl p-4 shadow text-center">
        <h2 className="text-xl font-bold text-indigo-900 mb-2">Fortune Mouse</h2>
        <div className="aspect-[9/16] bg-red-100 rounded-lg overflow-hidden relative mb-3">
          <img 
            src="https://img.cacaniqueisonline.com/wp-content/uploads/2024/05/fotune-mouse.jpg" 
            alt="Fortune Mouse"
